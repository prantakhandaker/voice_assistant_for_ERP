...
#         else:
#             return False  # Valid audio
#     except Exception as e:
#         print(f"Error while reading audio file: {e}")
#         return False  # Error case, treat as valid audio
...
#                 # Transcribe audio
#                 transcription = transcribe_audio(model, chunk_file)
#                 if transcription:  # Only proceed if transcription is non-empty
#                     os.remove(chunk_file)
#                     print(f"Customer: {transcription}")
                    
#                     # Add customer input to transcript
#                     customer_input_transcription += f"Customer: {transcription}\n"
...
#                         output = "Sorry, I couldn't process your request right now."
#                     if output:
#                         output = output.lstrip()
#                         vs.play_text_to_speech(output)
